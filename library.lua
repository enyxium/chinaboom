...
local library = utility.table({theme = table.clone(themes.chinaboom), folder = "chinaboom", extension = "cfg", flags = {}, open = true, keybind = Enum.KeyCode.RightShift, mousestate = services.InputService.MouseIconEnabled, cursor = nil, holder = nil, connections = {}}, true)
